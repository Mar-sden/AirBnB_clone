...
class HBNBCommand(cmd.Cmd):
    ...
    def do_show(self, line):
        ...
        for obj_id, obj in all_objs.items():
            if id == obj.id and obj._class.name_ == model:
                print(obj)
                return
    ...
    def do_destroy(self, line):
        ...
        for obj_id, obj in all_objs.items():
            if id == obj.id and obj._class.name_ == model:
                del obj
                del storage.FileStorage_objects[obj_id]
                storage.save()
                return
    ...
    def do_all(self, line):
        ...
        if name:
            ...
            for obj_id, obj in all_objs.items():
                if obj._class.name_ == name:
                    all_objs_ptr.append(obj._str_())
        else:
            for obj_id, obj in all_objs.items():
                all_objs_ptr.append(obj._str_())
    ...
    def update_dict(self, line, dict_):
        ...
        all_objs = storage.all()
        for obj_id, obj in all_objs.items():
            if obj.id == id and obj._class.name_ == model:
